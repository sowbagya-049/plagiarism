...
class DatasetManager:
    ...
    def init_database(self):
        ...
        # This is suitable for development but be cautious in production to avoid data loss.
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS reference_documents (
                ...
                embeddings TEXT,
                language TEXT,
                source_dataset TEXT, -- This column must exist in the schema
                created_at TEXT
            )
        ''')
        cursor.execute('''
...
class PANCorpusLoader:
    ...
    def download_pan_corpus(self, year=2020, task='plagiarism-detection'):
        ...
        # Example: Create a dummy file to simulate a download
    ...
    def load_pan_corpus(self):
        ...
        for doc in documents[:3]: # Create plagiarized versions for a subset
...
class QuoraDatasetLoader:
    ...
    def load_quora_dataset(self, sample_size=1000):
        ...
        # Example: Create a dummy file to simulate a download
        dummy_file_path = os.path.join(self.data_dir, f"quora_qqp_sample.json")
        sample_pairs = [
        ...
        with open(dummy_file_path, 'w', encoding='utf-8') as f:
            json.dump(documents[:sample_size], f, ensure_ascii=False, indent=4)
        print(f"Dummy Quora dataset saved to {dummy_file_path}")
...
class MRPCDatasetLoader:
    ...
    def load_mrpc_dataset(self, sample_size=500):
        ...
        # Example: Create a dummy file to simulate a download
        dummy_file_path = os.path.join(self.data_dir, f"mrpc_sample.json")
        sample_pairs = [
        ...
        with open(dummy_file_path, 'w', encoding='utf-8') as f:
            json.dump(documents[:sample_size], f, ensure_ascii=False, indent=4)
        print(f"Dummy MRPC dataset saved to {dummy_file_path}")
...
def main():
    ...
    # Clean up datasets directory before starting
    ...
    # IMPORTANT: Delete the SQLite database file if it exists before creating DatasetManager
    # This ensures a fresh database with the correct schema is always created.
